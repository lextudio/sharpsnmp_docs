...
`GitHub <https://github.com/lextm/sharpsnmplib/releases>`_ .
...
#SNMP Pro current release (1.2.0) requires #SNMP Library 9.0.5 and above, so
release 9.0.5 and above are all supported.

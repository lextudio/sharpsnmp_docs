# -*- coding: utf-8 -*-
#
# sharpsnmplib documentation build configuration file, created by
...
# Suppress ref.any warnings for array types (e.g. User[], Variable[,]).
...
htmlhelp_basename = 'sharpsnmplibdoc'
...
intersphinx_mapping = {
    'pro': (
        'https://docs.lextudio.com/sharpsnmppro/',
        '../pro/_build/html/objects.inv',
    )
}
